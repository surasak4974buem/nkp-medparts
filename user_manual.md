...
| หน้าจอ / ฟังก์ชันการใช้งาน | ระดับ 1: Admin | ระดับ 2: Stock Manager | ระดับ 3: General User |
| :--- | :---: | :---: | :---: |
...
* **ความสามารถหลัก:**
  ...
  * รหัสผ่านเริ่มแรกในการเปิดระบบคือ `NKP-admin-2026`
...
### 2. คลังอะไหล่และอุปกรณ์ (Catalog) - *เฉพาะสิทธิ์ Admin และ Stock Manager*
...
### 5. ใบขอจัดซื้ออะไหล่ (Purchase Request Generator) - *เฉพาะสิทธิ์ Admin และ Stock Manager*
...
1. ล็อกอินเข้าระบบด้วยสิทธิ์ **Admin** (รหัสผ่านเริ่มแรกคือ `NKP-admin-2026`)
