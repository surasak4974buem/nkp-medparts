...
6. คัดลอกลิงก์ **เว็บแอป URL (Web app URL)** ที่ระบบให้มา
...
4. ใส่ **LINE Bot Token** และ **LINE Group ID** (สำหรับกลุ่มแจ้งเตือนช่าง) จากนั้นกดบันทึกข้อมูลและสามารถกดทดสอบยิงแจ้งเตือนเพื่อใช้งานได้ทันทีครับ
